...
inline float pack_bfloat16_float(BFloat16 a, BFloat16 b) {
...
inline std::tuple<Vec256<float>, Vec256<float>> pack_bfloat16_float(const Vec256<BFloat16>& a, const Vec256<BFloat16>& b) {
...
inline std::tuple<BFloat16, BFloat16> unpack_float_bfloat16(float a) {
  uint32_t* ap = reinterpret_cast<uint32_t*>(&a);
  uint16_t hi = static_cast<uint16_t>((*ap) >> 16);
  uint16_t lo = static_cast<uint16_t>((*ap));
  BFloat16* hip = reinterpret_cast<BFloat16*>(&hi);
  BFloat16* lop = reinterpret_cast<BFloat16*>(&lo);
  return std::make_tuple(*hip, *lop);
}

inline std::tuple<Vec256<BFloat16>, Vec256<BFloat16>> unpack_float_bfloat16(const Vec256<float>& a, const Vec256<float>& b) {
