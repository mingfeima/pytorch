...
static PyMethodDef TorchMethods[] = {
  ...
  {"_get_mkldnn_enabled", (PyCFunction)THPModule_userEnabledMKLDNN, METH_NOARGS,     NULL},
  {"_set_mkldnn_enabled", (PyCFunction)THPModule_setUserEnabledMKLDNN, METH_O,  NULL},
...
#define ASSERT_TRUE(cmd) if (!(cmd)) return NULL
  ...
  ASSERT_TRUE(PyModule_AddObject(module, "has_mkldnn", at::hasMKLDNN() ? Py_True : Py_False) == 0);
